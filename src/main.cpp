...
uint256 hashGenesisBlock("0xf309c0cf40074eac7ec7d94aec519f28d9a1c31cfe3202e803678cf13c83ab89");
...
const string strMessageMagic = "garcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // garcoin: 1 days
static const int64 nTargetSpacing = 120; // garcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal garcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "garcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1795f533015886b7a9a518e1aa2d082f1599b9402d01ddc2412e6e51c5e790c3");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Building...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1393187869; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1080265;

        if (fTestNet)
        {
            block.nTime    = 1393042135;
            block.nNonce   = 892317;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfdf3a129d649ce4993cf3abb7c5515704f07a436c4940f29391ece8889235bf4"));
